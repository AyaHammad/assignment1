...
class AssigmentHome extends StatelessWidget {
  ...
  List<Widget> assigmentModelToWidgetConverter() {
    List<AssigmentModel> assigmentModels =
        assigmentsMapToAssigmentModelConverter();

    List<Widget> mealsWidgets =
        assigmentModels.map((e) => AssigmentWidget(e)).toList();
    return mealsWidgets;
  }
